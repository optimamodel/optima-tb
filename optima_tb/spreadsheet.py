...
def _createUnivalueSheet(ws, ws_name, cb_settings, formats, start_year, end_year, pop_labels):
    ...
    ws.set_column(0, col_index_start, 15)
    ws.set_column(col_index_start, col_index_end, 8)
    ws.set_column(col_index_end + 1, col_index_end + 2, 15)
