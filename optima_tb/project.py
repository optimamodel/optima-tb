...
class Project(object):
    ...
    def plotResults(self, results, colormappings=None, colorlabels=None, debug=False, pop_colormappings=None, pop_labels=None, plot_observed_data=True,savePlot=False,figName=None):
        ''' Plot all available results '''

        plotProjectResults(results, settings=self.settings, data=self.data, title = self.name.title(), colormappings=colormappings, colorlabels=colorlabels, pop_colormappings=pop_colormappings, pop_labels=pop_labels, debug = debug, plot_observed_data=plot_observed_data, save_fig=savePlot, fig_name=figName)
